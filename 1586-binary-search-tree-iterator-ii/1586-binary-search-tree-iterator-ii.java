...
class BSTIterator {
    ...
    //why need visited
    //That is because if a node is moved from the prev stack back to next by calling prev() method we shouldn't be looking at it's children again to add to nextStack.
